...
class PolicyLossConfig(BaseConfig):
    ...
    Args:
        loss_mode (str): Loss function mode. Options: 'vanilla', 'cispo', 'cispo_klcov',
            'clip-cov', 'kl-cov', 'gpg'. 'cispo_klcov' = CISPO base + KL-Cov overlay
            (kl_cov_ratio / ppo_kl_coef control the overlay).
